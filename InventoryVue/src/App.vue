      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <RouterLink class="collapse-item" to="/employees">All Employees</RouterLink>
            <RouterLink class="collapse-item" to="/employees-create">Add Employees</RouterLink>
          </div>
        </div>
      </li>
      <li class="nav-item">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>copyright &copy; {{ currentYear }} - developed by
              <b><a href="https://indrijunanda.gitlab.io/" target="_blank">Anague Sonna roosvelt</a></b>
            </span>
          </div>
        </div>
      </footer>
